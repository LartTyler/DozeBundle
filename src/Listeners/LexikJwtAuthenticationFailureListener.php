<?php
	namespace DaybreakStudios\DozeBundle\Listeners;

	use DaybreakStudios\DozeBundle\Errors\AccessDeniedError;
	...
	/**
	 * Converts exceptions thrown by the lexik/jwt-authentication-bundle package into Doze API errors.
	 */
	class LexikJwtAuthenticationFailureListener {
		/**
